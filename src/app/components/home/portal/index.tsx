export default function Portal() {
  return (
    <section id="portal" className="py-6"
      style={{ background: "var(--etl-portal-gradient)" }}>

      {/* Top accent */}
      <div className="h-1 w-full -mt-6 mb-5" style={{ background: "linear-gradient(90deg,#4fa3d1,#c8860a,#4fa3d1)" }} />

      <div className="container lg:max-w-screen-xl md:max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8">

        {/* Header */}
        <div className="flex flex-col items-center text-center mb-6" data-aos="fade-up">
          <h2 className="font-black text-white mb-3"
            style={{ fontFamily: "var(--font-barlow, sans-serif)", fontSize: "clamp(1.9rem,3.5vw,2.75rem)", lineHeight: 1.08 }}>
            Access ETL Services
          </h2>
          <div className="w-16 h-1 rounded-full mb-4" style={{ background: "linear-gradient(90deg,#4fa3d1,#c8860a)" }} />
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          ...
          <a href="/ETL-Quotation-Request.html"
            className="group flex flex-col items-center text-center p-6 rounded-3xl border-2 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl cursor-pointer"
            style={{ borderColor: "rgba(255,255,255,0.2)", background: "rgba(255,255,255,0.07)" }}
            data-aos="fade-right">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center text-3xl mb-4 transition-transform duration-300 group-hover:scale-110 shadow-lg"
