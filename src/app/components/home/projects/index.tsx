    ...
    <section id="projects" className="pt-14 pb-14 bg-white dark:bg-darkmode">
      <div className="container lg:max-w-screen-xl md:max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10" data-aos="fade-up">
          ...
          <h2 className="font-black text-midnight_text dark:text-white"
            style={{ fontFamily: "var(--font-barlow, sans-serif)", fontSize: "clamp(2rem,4vw,3rem)", lineHeight: 1.1 }}>
            Featured Projects
          </h2>
          <p className="text-gray text-sm mt-2 max-w-2xl">A curated selection from ETL&apos;s project portfolio. View the full list on the All Projects page.</p>
        </div>
        ...
        <div className="flex justify-center mt-12" data-aos="fade-up">
          <a href="/projects"
            className="inline-flex items-center gap-2 px-8 py-3.5 font-bold rounded-xl border-2 text-sm transition-all hover:-translate-y-0.5"
            style={{ borderColor: "#1a3c6e", color: "#1a3c6e", background: "#fff" }}>
            View All Projects
