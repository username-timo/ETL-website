        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="md:col-span-4 col-span-12 flex flex-col justify-start px-4 sm:px-0">
            ...
            <div className="flex items-center gap-2">
              <a aria-label="Chat on WhatsApp" href="https://wa.me/256704545163?text=Hello%20ETL%2C%20I%20would%20like%20to%20enquire%20about%20your%20engineering%20and%20procurement%20services." target="_blank" rel="noopener noreferrer"
            ...
            <div className="mt-5">
              ...
              <p className="text-gray text-sm">Monday – Friday: 9:00 AM – 6:00 PM</p>
