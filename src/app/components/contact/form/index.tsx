...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    fetch("https://formsubmit.co/ajax/tradelinksltd@gmail.com", {
      method: "POST",
        ...
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md">
          <div className="grid md:grid-cols-12 grid-cols-1 gap-8 items-center">  
            <div className="col-span-6">
              <h2 className="max-w-72 text-[40px] leading-[1.2] font-bold mb-9">Request Consultation</h2>
              <form onSubmit={handleSubmit} className="flex flex-wrap w-full m-auto justify-between">
                ...
                <div className="sm:flex gap-3 w-full">
                  ...
                  <div className="mx-0 my-2.5 flex-1">
                    <label htmlFor="Specialist" className="pb-3 inline-block text-17">Service Type*</label>
                    <select  
                    name="specialist"
                      id="specialist"
                      ...
                      <option value="Civil and Building Works">Civil and Building Works</option>
                      <option value="Road Construction and Maintenance">Road Construction and Maintenance</option>
                      <option value="Water Engineering">Water Engineering</option>
                      <option value="Electro-Mechanical Systems">Electro-Mechanical Systems</option>
